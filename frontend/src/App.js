  ...
  return (
    <div className="layout">
      ...
      <aside className="sidebar">
        ...
        <nav className="nav">
          <ul>
            <li><Link to="/sowing"><img src={iconSowing} alt="" /> Gestionar Siembra</Link></li>
            <li><Link to="/seeds"><img src={iconSeeds} alt="" /> Gestionar Semillas</Link></li>
            <li><Link to="/contacts"><img src={iconClients} alt="" /> Gestionar Clientes</Link></li>
            <li><Link to="/bookings"><img src={iconBookings} alt="" /> Gestionar Reservas</Link></li>
            <li><Link to="/sales"><img src={iconSales} alt="" /> Gestionar Ventas</Link></li>
          </ul>
        </nav>
      </aside>
